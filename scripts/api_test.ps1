...
$result = Invoke-ApiCall -Method "POST" -Endpoint "/merchant/products" -Headers $headers -Body $product1Body
...
$result = Invoke-ApiCall -Method "POST" -Endpoint "/merchant/products" -Headers $headers -Body $product2Body
...
$result = Invoke-ApiCall -Method "POST" -Endpoint "/merchant/products" -Headers $headers -Body $product3Body
...
if ($product1Id) {
    ...
    $result = Invoke-ApiCall -Method "PUT" -Endpoint "/merchant/products/$product1Id" -Headers $headers -Body $updateBody
...
if ($product1Id) {
    ...
    $result = Invoke-ApiCall -Method "PUT" -Endpoint "/merchant/products/$product1Id" -Headers $headers -Body $updateBody2
